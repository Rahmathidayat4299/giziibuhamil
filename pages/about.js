    ...
    <div>
      ...
      <div className="bg-gray-100">
        <div className="container mx-auto py-10 ">
          <div className=" py-10 mb-10 pb-20 flex justify-center items-center flex-col">
            <h1 className="text-5xl font-bold mb-6 mt-10 text-center">About Our Website</h1>
            <p className="text-lg text-gray-700 mb-10 mr-40 ml-40 mt-5 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-12 mt-20 ">
            <div className="flex items-center justify-center">
              <div className=" rounded-lg">
                ...
                <p className="text-gray-700">
                  ...
                  Back-End. Kami membuat wesite ini ditujukan untuk ibu hamil agar dapat mempermudah ibu hamil dalam mencari informasi gizi yang baik untuk kesehatan ibu dan anak dalam kandunganya.
                </p>
                <br />
                <p>
                  ...
                  bermanfaat dan membantu para ibu hamil dalam menjaga kesehatan mereka dan pertumbuhan bayi dalam kandungan.
                </p>
              </div>
            </div>
            <div className="flex  md:grid md:grid-cols-2 gap-8">
              <div className="flex gap-8 items-center justify-center">
                <div className="rounded-xl w-72 overflow-hidden shadow-md">
                  <img
              ...
              <div className="grid gap-8 md:grid-cols-1">
                <div className="rounded-xl w-72 h-50 overflow-hidden shadow-md">
                  <img
                ...
                <div className="rounded-xl w-72 h-30 overflow-hidden shadow-md">
                  <img
          ...
          <div className="grid grid-cols-1 rounded-lg md:grid-cols-2 lg:grid-cols-4 gap-8 mt-5">
      ...
      <div className="bg-gray-200 mt-0 justify-center items-center">
        <div className="flex ml-15  items-center justify-center">
          <h1 className="mb-4 text-4xl font-bold flex justify-center pt-6 text-center  text-gray-400">Institution Partners</h1>
        </div>
        <div className="flex m-5 p-7 gap-14 items-center justify-center">
          <div className="">
            <img
              ...
              alt="Logo UBL"
            />
            <h1 className="text-2xl py-3 font-bold text-center text-gray-400">Universitas Bandar Lampung</h1>
          </div>
          <div className="">
            <img
              ...
              alt="Logo UMG"
            />
            <h1 className="text-2xl py-3 font-bold text-center text-gray-400">Universitas Muhammadiyah Gersik</h1>
          </div>
          <div className="">
            <img
              ...
              alt="Logo Unilak"
            />
            <h1 className="text-2xl py-3 font-bold text-center text-gray-400">Universitas Lancang Kuning</h1>
          </div>
        </div>
      </div>
      <Footer />
